...
> **Примечание:** Для получения пошаговых инструкций по настройке DVC см. [`docs/homework_2/QUICKSTART.md`](QUICKSTART.md) или общий [`docs/QUICKSTART.md`](../QUICKSTART.md) (Шаг 5-13). Данный отчет описывает **что было настроено**, а не **как это настроить**.
