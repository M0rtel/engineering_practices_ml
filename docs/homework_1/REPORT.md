...
> **Примечание:** Для получения пошаговых инструкций по настройке проекта см. [`docs/homework_1/QUICKSTART.md`](QUICKSTART.md) или общий [`docs/QUICKSTART.md`](../QUICKSTART.md). Данный отчет описывает **что было настроено**, а не **как это настроить**.
